...
public class ChinarMergeMesh : MonoBehaviour
{
    ...
    private void MergeMesh()
    {
        ...
        newMf.sharedMesh = newMesh; //给当前空物体，添加网格组件；将合并后的网格，给到自身网格
        ...
        //获取新的材质赋值
        Material mat = Resources.Load<Material>("sphere");
        this.gameObject.AddComponent<MeshRenderer>().material = mat;
        ObjExporter.MeshToFile(newMf, Application.dataPath + "/Export.obj", 1);
    }
}